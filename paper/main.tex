...
\begin{figure}[H]
	...
	\caption{Left: contrastive activation maps from the default training run. Middle: contrastive activations maps from the Abalted CE+KLD training run. Right: contrastive activation maps from the Abalted CE training run.}
\end{figure}
...
\begin{table}[h]
	...
	\begin{tabular}{c|ccc}
		...
		Abltated CE (Ours) & 3.610 & 3.1\% & 4.9\% \\
		Abltated CE + KLD (Ours) & \bf 2.743 & \bf 93.0\% & \bf 51.5\% \\
		\bottomrule
	\end{tabular}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{c|c}
		...
		\midrule
		Cross-Entropy & 77.0\% \\
		Abltated CE (Ours) & 75.7\% \\
		Abltated CE + KLD (Ours) & \bf 83.4\% \\
		\bottomrule
	\end{tabular}
\end{table}
