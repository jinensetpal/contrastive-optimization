...
%In addition to learning invariances to spurious correlation, having information about the specific region containing the classification target motivates learning scale-robust representations of the target.
...
\begin{table}[h!]
	...
	\begin{tabular}{c|c|ccc|c}
		...
		\midrule
		DyTBN (Baseline) & 93.07 & 76.67 & 71.73 & 68.27 & -0.22 \\
		\midrule
		...
		ACE + SWD + DyTBN (Ours) & 87.73 & 45.86 & 34.80 & 40.93 & 0.16 \\
		\midrule
		Gold Standard & 100.00 & 06.67 & 06.67 & 06.67 & 1.00 \\
		\bottomrule
	\end{tabular}
\end{table}
